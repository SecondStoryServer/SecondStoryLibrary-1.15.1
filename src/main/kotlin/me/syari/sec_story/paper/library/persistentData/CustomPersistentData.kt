...
import me.syari.sec_story.paper.library.persistentData.customType.CustomPersistentDataType
import org.bukkit.NamespacedKey
import org.bukkit.persistence.PersistentDataContainer
import org.bukkit.persistence.PersistentDataType
import org.bukkit.plugin.java.JavaPlugin

class CustomPersistentData(private val plugin: JavaPlugin, private val persistentDataContainer: PersistentDataContainer){
    ...
    fun setBoolean(key: String, value: Boolean?){
        set(key, PersistentDataType.BYTE, when(value){
            true -> 1.toByte()
            false -> 0.toByte()
            null -> null
        })
